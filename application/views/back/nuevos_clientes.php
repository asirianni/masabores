       ...
       <!-- Navigation -->
        ...
        <div id="page-wrapper">
            <div class="row">
                ...
                <i class="fa fa-arrow-circle-right"> </i><a href='<?php echo site_url('backoffice/nuevos_clientes')?>'> Nuevos Clientes </a> |
	            ...
	            <i class="fa fa-table fa-fw"></i><a href='<?php echo site_url('backoffice/provincias')?>'> ABM Provincias </a>
                <!-- /.col-lg-12 -->
            </div>
            <div class="row">
	            <?php echo $output; ?>
