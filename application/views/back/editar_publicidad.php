...
$(document).ready(function(){
  ...
  <?php
    ...
    { ?>
      ...
      ubicaciones.push({
         ...
         "id_subrubro":'<?php echo $ubicaciones[$i]["id_subrubro"]; ?>',
         ...
         "sub_rubro_subrubro":'<?php echo $ubicaciones[$i]["sub_rubro_subrubro"]; ?>',  
      });
  ...
  for(var i=0; i < ubicaciones.length;i++)
  {
    ...
    <input type='text' name='id_subrubro[]' value='"+ubicaciones[i]["id_subrubro"]+"'> \n\
    </div>";
