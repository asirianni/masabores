            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href='<?php echo site_url('backoffice/abm_productos_administrador')?>'><i class="fa fa-table fa-fw"></i> Productos</a>
                        </li>
                        <li>
                            <a href='<?php echo site_url('backoffice/abm_p_especiales_administrador')?>'><i class="fa fa-table fa-fw"></i> Productos Portada</a>
                        </li>
                        <li>
                            <a href='<?php echo site_url('backoffice/abm_rubros_administrador')?>'><i class="fa fa-table fa-fw"></i> Rubros</a>
                        </li>
                        <li>
                            <a href='<?php echo site_url('backoffice/abm_subrubros_administrador')?>'><i class="fa fa-table fa-fw"></i> SubRubros</a>
                        </li>
                        <li>
